  ...
  dashboardPage(
    ...
    dashboardSidebar(
      ...
      sidebarMenu(
        ...
        menuItem("Time series completeness", tabName = "comp", icon = icon("pie-chart")),
        menuItem("Length of time series", tabName = "Length", icon = icon("ruler")),
      ...
      tabItems(
        tabItem(tabName = "Home",
                ...
                tags$ul(
                  ...
                  tags$li("🔢 Understand how the number of data points and completeness of the time series required influences overarching trends"),
                  tags$li("📏 Investigate how the length of time series changes the C-LPI"),
                ...
                tags$a(href="https://wwf.ca/wp-content/uploads/2025/09/WWF_LPRC_Technical_Supplement.pdf", "Currie et al. 2025. Living Planet report Canada 2025 Technical Supplement, WWF-Canada"),
                br(),
                tags$a(href="https://www.facetsjournal.com/doi/10.1139/facets-2025-0112", "Currie et al. 2026. Navigating methodological decisions: Balancing rigor and data volume of the Canadian Living Planet Index, FACETS"),
                br(),
        ...
        tabItem(tabName = "comp",
                h2("Completeness of time series"),
                p("There are no set criteria for completeness of a time series to warrant inclusion in the C-LPI. Completeness is calculated based on the number of data points in a time series divided by the time period it covers (i.e., length), where, for instance, a time series from 2015-2020 with 2 data points is considered 40% complete). We explored four time series completeness levels: (i) >0%, (ii) >25%, (iii) >50%, and (iv) >75%."),
                uiOutput("comp_select"),
                uiOutput("comp_plot")
        ),
        tabItem(tabName = "Length",
                h2("Length of time series"),
                p("There are no set criteria for how long a time series should be to warrant inclusion in the C-LPI. Here we explored 4 options: a minimum of 5 years, 10 years, 15 years, and 20 years. Time series length shows a range of final index values from 0.87 to 0.99 for the four options explored, where inclusion of shorter time series length produces a more negative trajectory and final index value relative to indices that contain data restricted to longer time length."),
