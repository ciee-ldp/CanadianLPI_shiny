    ...
    dashboardBody(
      ...
      tabItems(
        tabItem(tabName = "Home",
                ...
                br(),
                tags$a(href="https://www.facetsjournal.com/doi/10.1139/facets-2025-0112", "Currie et al. 2025. Navigating methodological decisions: Balancing rigor and data volume of the Canadian Living Planet Index, FACETS"),
                br(),
