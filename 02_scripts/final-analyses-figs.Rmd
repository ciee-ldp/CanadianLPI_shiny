...
cad <- read.csv(here("data", "CAD_Paper_withzeroes.csv"), header=TRUE)
...
infile_u <- create_infile(cad,
                          start_col_name = "X1950",  # data start year
                          end_col_name = "X2020",    # data end year
                          CUT_OFF_YEAR = 1970,       # filters all data out existing before this year
                          name = "./02_outdata/Group3_Confidence-Intervals/CAD_20240607_unweighted") # name the infile/outputs
...
# save file 
# write.csv(cad_20240607_u,file.path("02_outdata","Group3_Confidence-Intervals","LPI-sensitivity_conf-int_CAD-unweighted-year-CIs.csv"))
